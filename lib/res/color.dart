...
class AppColors {
  ...
  static const Color primaryColor =  Color(0xff005e64);
  static const Color primaryColorDeep =  Color(0xff006467);
  static const Color secondaryColor =  Color.fromRGBO(0, 0, 0, 1.0);

  static const Color primaryTextTextColor =  Color(0xff030303);
  ...
  static const Color textFieldDefaultFocus =  Color(0xfffc0006);
